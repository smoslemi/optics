...
base1= 'nchAddDropFiler';
outputFile =load('nchAddDropFilter.1-DC.2d_dat');
Ref1=0;
TH1=1;
Right1= 0.0;
Left1= 0.0;
...
x24In=10.^(outputFile(:,20)./20);
x24Out=10.^(outputFile(:,21)./20);
...
plot(x,N12InDB,'r',x,N22InDB,'g',x,N32InDB,'b',x,N42InDB,'y',x,N52InDB,'m',x,N62InDB,'c');
legend('N12InDB','N22InDB','N32InDB','N42InDB','N52InDB','N62InDB');
