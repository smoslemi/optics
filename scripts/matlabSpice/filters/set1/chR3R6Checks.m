...
base1= 'chR3R6Checks';
outputFile =load('chR3R6Checks.1-DC.2d_dat');
mFile =load('chR3R6Checks.1-DC.2d_dat');
Ref1=0.1;
TH1=0.9;
Right1= 0.1;
Left1= 0.1;
...
plot(x,x13O,'r',x,x23O,'g',x,N33O,'b',x,x43O,'y',x,x53O,'m',x,N63O,'c',x,x73O,'k',x,x83O,':r');
legend('x13O','x23O','N33O','x43O','x53O','N63O','x73O','x83O');

figure('name','Array Drop ports','numbertitle','off');
plot(x,x12O,'r',x,x22O,'g',x,N32I,'b',x,x42O,'y',x,x52O,'m',x,N62I,'c',x,x72O,'k',x,x82O,':r');
legend('x12O','x22O','N32I','x42O','x52O','N62I','x72O','x82O');
