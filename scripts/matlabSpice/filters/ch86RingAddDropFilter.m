...
base1= '8ch6RingAddDropFilter';
outputFile =load('8ch6RingAddDropFilter.1-DC.2d_dat');
mFile =load('8ch6RingAddDropFilter.1-DC.2d_dat');
Ref1=0.1;
TH1=0.9;
Right1= 0.1;
Left1= 0.1;
...
N11OutDB=outputFile(:,3);
N12OutDB=outputFile(:,4);
N12InDB=outputFile(:,5);
N13OutDB=outputFile(:,6);
N13InDB=outputFile(:,7);
N14InDB=outputFile(:,8);
