...
c1x14InDB=outputFile(:,18);
c1x14OutDB=outputFile(:,19);

c1x23InDB=outputFile(:,20);
c1x23OutDB=outputFile(:,21);
c1x24InDB=outputFile(:,22);
c1x24OutDB=outputFile(:,23);

rN11InDB=outputFile(:,24);
rN11OutDB=outputFile(:,25);
rN12OutDB=outputFile(:,26);
rN12InDB=outputFile(:,27);
rN13OutDB=outputFile(:,28);
rN13InDB=outputFile(:,29);
rN14OutDB=outputFile(:,30);
rN14InDB=outputFile(:,31);

rN21InDB=outputFile(:,32);
rN21OutDB=outputFile(:,33);
rN22OutDB=outputFile(:,34);
rN22InDB=outputFile(:,35);
rN23OutDB=outputFile(:,36);
rN23InDB=outputFile(:,37);
rN24OutDB=outputFile(:,38);
rN24InDB=outputFile(:,39);

rx14InDB=outputFile(:,40);
rx14OutDB=outputFile(:,41);

rx23InDB=outputFile(:,42);
rx23OutDB=outputFile(:,43);
rx24InDB=outputFile(:,44);
rx24OutDB=outputFile(:,45);
