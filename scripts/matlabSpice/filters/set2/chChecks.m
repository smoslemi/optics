...
base1= 'chSet2Checks';
outputFile =load('chSet2Checks.1-DC.2d_dat');
mFile =load('chSet2Checks.1-DC.2d_dat');
Ref1=0.1;
TH1=0.9;
Right1= 0.1;
Left1= 0.1;
...
[nroutputFile,ncoutputFile]=size(mFile);
...
% % Only ch 6 outs
figure('name','Ring Drop port','numbertitle','off');
subplot(3,3,1)
plot(x,N12I);
legend('N12I');
