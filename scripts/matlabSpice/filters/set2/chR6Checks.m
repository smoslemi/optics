...
base1= 'chR6Checks';
outputFile =load('chR6Checks.1-DC.2d_dat');
mFile =load('chR6Checks.1-DC.2d_dat');
Ref1=0.1;
TH1=0.9;
Right1= 0.1;
Left1= 0.1;

basePath = '/Users/sanam/phd/GitThesis/optics/scripts/matlabSpice/filter/set2/';
...
plot(x,x13O,'r',x,x23O,'g',x,x33O,'b',x,x43O,'y',x,x53O,'m',x,N63O,'c',x,x73O,'k',x,x83O,':r');
legend('x13O','x23O','x33O','x43O','x53O','N63O','x73O','x83O');

figure('name','Array Drop ports','numbertitle','off');
plot(x,x12O,'r',x,x22O,'g',x,x32O,'b',x,x42O,'y',x,x52O,'m',x,N62I,'c',x,x72O,'k',x,x82O,':r');
legend('x12O','x22O','x32O','x42O','x52O','N62I','x72O','x82O');
