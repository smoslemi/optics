...
base1= 'chR5Checks';
outputFile =load('chR5Checks.1-DC.2d_dat');
mFile =load('chR5Checks.1-DC.2d_dat');
Ref1=0.1;
TH1=0.9;
Right1= 0.1;
Left1= 0.1;
...
plot(x,x13O,'r',x,x23O,'g',x,x33O,'b',x,x43O,'y',x,N53O,'m',x,x63O,'c',x,x73O,'k',x,x83O,':r');
legend('x13O','x23O','x33O','x43O','N53O','x63O','x73O','x83O');

figure('name','Array Drop ports','numbertitle','off');
plot(x,x12O,'r',x,x22O,'g',x,x32O,'b',x,x42O,'y',x,N52I,'m',x,x62O,'c',x,x72O,'k',x,x82O,':r');
legend('x12O','x22O','x32O','x42O','N52I','x62O','x72O','x82O');
