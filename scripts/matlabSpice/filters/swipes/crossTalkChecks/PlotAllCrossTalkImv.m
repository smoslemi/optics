...
%     legend('N13O','N23O','N33O','N43O','N53O','N63O','N73O','N83O');
    ...
    plot(x,NTri12I,'r',x,NTri22I,'g',x,NTri32I,'b',x,NTri42I,'y',x,NTri52I,'m',x,NTri62I,'c',x,NTri72I,'k',x,NTri82I,':r');
    legend('NTri12I','NTri22I','NTri32I','NTri42I','NTri52I','NTri62I','NTri72I','NTri82I');
    xlim=get(gca,'XLim');
    ylim=get(gca,'YLim');
    text(xlim(2),ylim(2)-10,desc);
    ...
    plot(x,N52I,':r',x,NTH52I,'g',x,NTri52I,'-.b');
    legend('N52I','NTH52I','NTri52I');
    xlim=get(gca,'XLim');
    ylim=get(gca,'YLim');
    text(xlim(2),ylim(2)-10,desc);
    
    figure('name','crosstalk compare CH6','numbertitle','off');
    plot(x,N62I,':r',x,NTH62I,'g',x,NTri62I,'-.b');
    legend('N62I','NTH62I','NTri62I');
    xlim=get(gca,'XLim');
    ylim=get(gca,'YLim');
    text(xlim(2),ylim(2)-10,desc);
    
    figure('name','crosstalk compare CH7','numbertitle','off');
    plot(x,N72I,':r',x,NTH72I,'g',x,NTri72I,'-.b');
    legend('N72I','NTH72I','NTri72I');
    xlim=get(gca,'XLim');
    ylim=get(gca,'YLim');
    text(xlim(2),ylim(2)-10,desc);
    ...
    plot(x,N82I,':r',x,NTH82I,'g',x,NTri82I,'-.b');
    legend('N82I','NTH82I','NTri82I');
    xlim=get(gca,'XLim');
    ylim=get(gca,'YLim');
    text(xlim(2),ylim(2)-10,desc);
