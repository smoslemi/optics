...
plot(x,N13O,'r',x,N23O,'g',x,x33O,'b',x,x43O,'y',x,x53O,'m',x,x63O,'c',x,x73O,'k',x,x83O,':r');
legend('N13O','N23O','x33O','x43O','x53O','x63O','x73O','x83O');

figure('name','Array Drop ports','numbertitle','off');
plot(x,N12I,':r',x,N22I,'-.g',x,x32O,'b',x,x42O,'y',x,x52O,'m',x,x62O,'c',x,x72O,'k',x,x82O,':r');
legend('N12I','N22I','x32O','x42O','x52O','x62O','x72O','x82O');
