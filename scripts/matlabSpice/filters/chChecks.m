...
for i=1:NDiv
    ...
    c{:};
    if i==1
        %[N11I, N12I, N13I, N14I] = c{(i-1)*NPort+1:i*NPort};
        [N11I, N12I, N13I, N14I,N11O, N12O, N13O, N14O] = c{(i-1)*NPort+1:i*NPort};
        %N11I
        %N14I
    end;
    if i==2
        %[N21I, N22I, N23I, N24I] = c{(i-1)*NPort+1:i*NPort};
...
% plot(x,N12InDB,':r',x,N22InDB,'-.g',x,N32InDB,':r',x,N42InDB,'-.g');
% legend('N12InDB','N22InDB');
% 
% figure('name','Array Drop ports','numbertitle','off');
% plot(x,N12I,':r',x,N22I,'-.g',x,N32I,'--b',x,N42I,'--y',x,N52I,'-.m',x,N52I,'-.c',x,N72I,':k',x,N82I,'-.r');
% legend('N12I','N22I');
...
legend('N12O','N22O','N32O','N42O','N52O','N62O','N72O','N82O');
