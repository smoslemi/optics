...
base1= 'chR1R2R6Checks';
outputFile =load('chR1R2R6Checks.1-DC.2d_dat');
mFile =load('chR1R2R6Checks.1-DC.2d_dat');
Ref1=0.1;
TH1=0.9;
Right1= 0.1;
Left1= 0.1;
...
figure('name','D2 Ring','numbertitle','off');
subplot(4,2,1);
plot(x,N21I);
legend('N21I');
subplot(4,2,3);
...
plot(x,N13O,'r',x,N23O,'g',x,x33O,'b',x,x43O,'y',x,x53O,'m',x,N63O,'c',x,x73O,'k',x,x83O,':r');
legend('N13O','N23O','x33O','x43O','x53O','N63O','x73O','x83O');

figure('name','Array Drop ports','numbertitle','off');
plot(x,N12I,':r',x,N22I,'-.g',x,x32O,'b',x,x42O,'y',x,x52O,'m',x,N62I,'c',x,x72O,'k',x,x82O,':r');
legend('N12I','N22I','x32O','x42O','x52O','N62I','x72O','x82O');
