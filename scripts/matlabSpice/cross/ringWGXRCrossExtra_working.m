...
subplot(3,1,1);
plot(x,N63OutTHPhi,':r',x,x71InTHPhi,'-.g',x,N63InTHPhi,'--b',x,x71OutTHPhi,':m');
legend('N63OutTHPhi','x71InTHPhi','N63InTHPhi', 'x71OutTHPhi','Location','eastoutside');
title('Circuit TH, wg1, phase shifts');
subplot(3,1,2);
plot(x,x73OutTHPhi,':r',x,w3eOutTHPhi,'-.g',x,x73InTHPhi,'--b',x,w3eInTHPhi,':m');
legend('x73OutTHPhi','w3eInTHPhi','x73InTHPhi', 'w3eOutTHPhi','Location','eastoutside');
title('Circuit TH, wg3, phase shifts');
subplot(3,1,3);
...
%fTH_TH_Phi + N61InTHPhi + 2.*fWG3_TH_PhiF;
x73OutRightPhi_theo = N63OutRightPhi + fWG1_TH_PhiF;
figure('name','Circuit TH vs Right, Waveguides Phase shifts','numbertitle','off');
plot(x,fWG1_TH_PhiF,':r',x, fWG1_Right_PhiF,'--g',x,fWG1_TH_PhiF+x73OutRightPhi_theo,'-.k',x,w3eInRightPhi,':b');
legend(',fWG1-TH-PhiF','fWG1-Right-PhiF', 'theo out', 'sim out');
